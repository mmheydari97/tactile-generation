...
for i in range(file_count):
    ...
    # with plt.style.context(random.choices(['default', 'dark_background'], weights=[.85, .15])[0]):
    ...
    with plt.style.context('default'):
        ...
        if GRID_PARAM < 0.40:
            draw_grids(ax2, color='k', linestyle='--', linewidth=2)
        ...
        plt.savefig(f'./tactile/t_{i+1}.jpg')
